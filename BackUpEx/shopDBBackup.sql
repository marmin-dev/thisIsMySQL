...
INSERT INTO `deletedMemberTBL` VALUES ('Dang','당탕이','경기 부천시 중동','2022-11-19');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_deletedMemberTBL` AFTER DELETE ON `membertbl` FOR EACH ROW BEGIN
...
-- Dump completed on 2022-11-19  1:50:36
